    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.error.includes("secret key")) {
          ...
          setErrors({
            password: data.error || "Login failed. Please try again.",
          });
        }
      }
    } catch (error: any) {
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              <svg
                className="w-8 h-8 text-heading"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <h1 className="text-2xl font-display text-heading mb-2">
              Admin Access
            </h1>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-yellow-300/80 text-sm mt-1">
                  Admin access requires a valid secret key. Contact your system
                  administrator if you don&apos;t have the key.
                </p>
              </div>
            </div>
          </motion.div>
